module github.com/win30221/ichiban-kuji

go 1.17

require (
	github.com/win30221/code v0.0.0-20220823082040-d4ca8ae4eab8
	github.com/win30221/core v0.0.0-20220824024253-2cd55457a868
